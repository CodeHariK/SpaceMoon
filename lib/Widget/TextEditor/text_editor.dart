...
final exampleJson = [
  ...
  {
    "insert": "\n",
    "attributes": {"alignment": "center", "heading": 1}
  }
];
...
class _TextEditorState extends State<TextEditor> {
  ...
  String get toFile => jsonEncode(_controller?.document.toJson());
  ...
  Future<void> _initController() async {
    try {
      final result = widget.jsonData ?? jsonEncode(exampleJson);
  ...
  Widget build(BuildContext context) {
    return PopScope(
      onPopInvokedWithResult: (didPop, result) {
        widget.onPopInvoked?.call(didPop, toFile);
      },
      child: Scaffold(
        backgroundColor: Theme.of(context).scaffoldBackgroundColor,
        extendBodyBehindAppBar: Device.isDesktop || Device.isWeb,
